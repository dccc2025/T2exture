...
TABLE_ROWS = {
    ...
    'table03_passive_context': [
        ('passive-refs-00', '0 total passive refs'),
        ('passive-refs-02', '2 total passive refs'),
        ('passive-refs-04', '4 total passive refs'),
        ('passive-refs-06', '6 total passive refs'),
        ('passive-refs-08', '8 total passive refs'),
        ('passive-refs-10', '10 total passive refs'),
    ],
    'table04_active_sparsity': [
        ('active-stride-02', 'active stride 2'),
        ('active-stride-03', 'active stride 3'),
        ('active-stride-04', 'active stride 4'),
        ('active-stride-05', 'active stride 5'),
        ('active-stride-06', 'active stride 6'),
        ('active-stride-07', 'active stride 7'),
        ('active-stride-08', 'active stride 8'),
        ('active-stride-09', 'active stride 9'),
        ('active-stride-10', 'active stride 10'),
        ('active-stride-11', 'active stride 11'),
    ],
    'table05_deployment': [
        ('amt-s-vanilla', 'AMT-S vanilla'),
        ('amt-s-t2texture', 'AMT-S T2exture'),
