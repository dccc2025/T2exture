...
from scripts.baselines.evaluate_bim_vfi import load_model as load_bim_model
from scripts.baselines.evaluate_gimm_vfi_f import load_model as load_gimm_model
from scripts.baselines.evaluate_ifrnet import load_model as load_ifrnet_model
from scripts.baselines.evaluate_sgm_vfi import load_model as load_sgm_model
...
def main() -> None:
    ...
    data_root = Path(config.get('real_data_root', 'datasets/real'))
