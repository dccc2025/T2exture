...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument('--pretrained', type=Path, default=None, help='Optional AMT init checkpoint. Full T2exture checkpoints can be evaluated without it.')
...
def main() -> None:
    ...
    checkpoint = torch_load_portable(args.checkpoint, device)
